...
def calculate_three_room_bricks(
    i: ThreeRoomBricksInput,
) -> ThreeRoomBricksOutput:
    ...
    p3 = perimeter(i.room3_length_m, i.room3_width_m)

    total_perimeter = p1 + p2 + p3
    wall_volume = total_perimeter * i.wall_height_m * i.wall_thickness_m
