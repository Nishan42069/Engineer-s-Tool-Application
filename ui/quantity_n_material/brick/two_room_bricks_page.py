...
from calculators.quantity_n_material.brick.two_room_bricks import (
    TwoRoomBricksInput,
...
def render():
    ...
    if st.button("Calculate two room bricks"):
        ...
        out = calculate_two_room_bricks(inp)
